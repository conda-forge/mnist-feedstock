About mnist-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mnist-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/datapythonista/mnist

Documentation: https://github.com/datapythonista/mnist
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3107&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mnist-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mnist` can be installed with `conda`:
...
It is possible to list all of the versions of `mnist` available on your platform with `conda`:
...
```
mamba search mnist --channel conda-forge
```
...
mamba repoquery search mnist --channel conda-forge

# List packages depending on `mnist`:
mamba repoquery whoneeds mnist --channel conda-forge

# List dependencies of `mnist`:
mamba repoquery depends mnist --channel conda-forge
```
